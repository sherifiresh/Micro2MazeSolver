...
public class CarController : MonoBehaviour {
    ...
    Queue<curPos> Q = new Queue<curPos>();
    public int[] visitedS;
    public int[] visitedB;
    ...
    public float movingTimerMax = 1f;
    public float rotationTimerMax = 1f;
    public int rotateDir = 0; //-1 = left # 1 = right
    public int movementMode; //0 none, 1 move, 2 rotation
